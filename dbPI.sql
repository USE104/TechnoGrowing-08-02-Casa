...
insert into tbVoluntario (Nome,dataNascimento,Email,Senha,CPF,Tel,Experiencia,RedeSocial,Url) values ('Erik Oliveira','1997-06-27','Erick.O@senacsp.com',SHA1('12345'),'111.111.111-11','(011)91234-5678','Iniciante','Github','');
insert into tbVoluntario (Nome,dataNascimento,Email,Senha,CPF,Tel,Experiencia,RedeSocial,Url) values ('Herick Cesar','1996-08-31','Herick.C@senacsp.com',SHA1('123456'),'111.111.111-12','(011)91234-5659','Iniciante','Github','');
insert into tbVoluntario (Nome,dataNascimento,Email,Senha,CPF,Tel,Experiencia,RedeSocial,Url) values ('Wesley','1994-12-25','Wesley@senacsp.com',SHA1('123457'),'111.111.111-13','(011)91234-5648','Iniciante','Linkdlin','');
insert into tbVoluntario (Nome,dataNascimento,Email,Senha,CPF,Tel,Experiencia,RedeSocial,Url) values ('Gabriel Souza','1990-12-24','gabriel.S@senacsp.com',SHA1('123459'),'111.111.111-17','(011)91234-5677','Iniciante','Github','');
